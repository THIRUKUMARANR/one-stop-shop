	...
	<div class="container">
		...
		<div>
			<form:form action="product" method="POST" commandName="product"
				...
				<div class="form-group">
					<form:label class="control-label col-sm-2" path="categoryname">Product Category:</form:label>
					<div class="col-sm-10">
						...
						<form:select path="categoryname" class="form-control" >
							<c:if test="${!empty categoryList}" >
								<c:forEach items="${categoryList}" var="admin">
									...
									<form:option value="${admin.categoryname}" />
				...
				<div class="form-group">
					<form:label class="control-label col-sm-2" path="price">Enter Product Price:</form:label>
					<div class="col-sm-10">
