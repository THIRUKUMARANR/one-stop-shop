		...
		<form class="form-horizontal">
			<div class="container">
				...
				<div class="form-group">
					<label class="col-md-8 control-label" for="billingPlotNumber">Plot
						Number</label>
					<div class="col-md-8">
						<form:input path="plotNo" id="billingApartmentNumber"
							class="form-Control" />
						<!-- to display validation messages -->
						<c:forEach
							items="${flowRequestContext.messageContext.getMessagesBySource('plotNo')}"
							var="err">
							<div>
								<span>${err.text}</span>
							</div>
				...
				<div class="form-group">
					<label class="col-md-8 control-label" for="billingStreet">Street
						Name</label>
					<div class="col-md-8">
						<form:input path="streetName" id="billingStreet"
							class="form-Control" />
						<!-- to display validation messages -->
						<c:forEach
							items="${flowRequestContext.messageContext.getMessagesBySource('streetName')}"
							var="err">
							<div>
								<span>${err.text}</span>
							</div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<form:input path="country" id="billingCountry"
							class="form-Control" />
					</div>
				</div>
				...
				<br /> <input type="submit" value="Next" class="btn btn-default"
